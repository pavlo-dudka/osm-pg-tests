...
call osmosis-latest\bin\osmosis --ts user="postgres" password="postgres" host="localhost:5432"
call osmosis-latest\bin\osmosis --rb ..\temp\ua.filtered.pbf --lp --ws user="postgres" password="postgres" host="localhost:5432" nodeLocationStoreType="InMemory"
