...
where coalesce(rr.ref,'-')<>coalesce(replace(replace(wtr.v,',',';'),'; ',';'),'-') and not(rr.ref is null and wtr.v similar to '[ОСDLR0-9]%|[МНР][0-9]*' or rr.ref similar to '[ОС]%' and wtr.v is null)
