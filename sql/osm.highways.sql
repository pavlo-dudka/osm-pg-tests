...
from ways w
  inner join way_tags wt on wt.way_id=w.id and wt.k='highway' and wt.v not in ('bus_stop','emergency_access_point','platform','footway','path','cycleway','steps','proposed','road','track')
