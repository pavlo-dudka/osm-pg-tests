...
call config.bat
@set peirceUrl=peirce.gis-lab.ru

start "" binaries\wget.exe http://%peirceUrl%/qa/UA-C/rss -O temp\UA-C.rss
start "" binaries\wget.exe http://%peirceUrl%/qa/UA-E/rss -O temp\UA-E.rss
start "" binaries\wget.exe http://%peirceUrl%/qa/UA-N/rss -O temp\UA-N.rss
start "" binaries\wget.exe http://%peirceUrl%/qa/UA-S/rss -O temp\UA-S.rss
start "" binaries\wget.exe http://%peirceUrl%/qa/UA-W/rss -O temp\UA-W.rss
start "" binaries\wget.exe http://%peirceUrl%/qa/RU-KRM/rss -O temp\RU-KRM.rss
...
rem start "peirce.citiesWithoutPlacePolygon" %psql_exe%  -f peirce\citiesWithoutPlacePolygon.sql -o results\peirce.citiesWithoutPlacePolygon.geojson -q
...
set file=%~1
set region=%file:~0,-4%
if "%newhash%" neq "%oldhash%" (binaries\wget.exe http://%peirceUrl%/ADDR_CHK/%region%.mp_addr.xml -O "%pg_data_folder%\%region%.mp_addr.xml")
goto :eof
